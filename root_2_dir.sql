...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2025 at 05:23 AM
...
INSERT INTO `admin_comments` (`id`, `title`, `abstract`, `others`, `file_id`, `admin_id`) VALUES
...
ALTER TABLE `admin_comments`
  ...
  ADD CONSTRAINT `admin_comments_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `tbl_user` (`id`) ON DELETE CASCADE;
COMMIT;
